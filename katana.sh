...
banner() {
   ...
   .  ..........................................
      ...
      .........................................
        .......................................
EOF
    echo -e "\n${bold_red}			Katana${normal}"
    echo -e "                TikTok Username Checker\n"
}
...
check_username() {
    ...
    if [ -z "$uniqueId" ]; then
        echo -e "Checked username: ${bold_green}@$username${normal} is available."
        echo "$username" >> "$AVAILABLE_FILE"
        # Increment available count
        available_count=$((available_count + 1))
    else
        echo -e "Checked username: ${bold_red}@$username${normal} is already taken."
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        -u|--username)
            if [[ -n "$2" && ${2:0:1} != "-" ]]; then
                TARGET="$2"
                echo -e "Checking for usernames: ${bold}@$2${normal}\n"
                shift 2
            else
...
echo -e "\n${bold_green}[¡]${normal}${bold} Process finished.${normal} Total time: ${bold}$elapsed seconds.${normal}\n"
